...
**Epusdt**（Easy Payment USDT）是一个面向 **TRON 上 USDT 收款流程** 的自托管支付中间件。
...
- **多钱包轮询**：支持多个收款地址参与轮询，提高并发处理能力。
- **异步支付回调**：支付成功后通知你的业务系统。
- **Telegram 机器人支持**：可选的通知和基础管理流程能力。
...
- **推荐外部依赖**：需要可访问 TronGrid API 来查询 TRON / TRC20 链上数据
